    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <header className="sticky top-0 bg-white shadow-sm z-10">
        <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
          <h1 className="text-xl font-bold text-orange-700">Editar Perfil</h1>
          <button 
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-8">
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {outrasAtividades.map((atividade, index) => (
                <div key={index} className="flex items-center bg-orange-100 px-3 py-1 rounded-full">
                  <span>{atividade}</span>
                  <button 
        ...
        <div className="sticky bottom-4 z-10">
          <button
            onClick={salvarPerfil}
            className="w-full py-4 bg-orange-600 text-white font-bold text-lg rounded-lg shadow-lg hover:bg-orange-700"
          >
            SALVAR PERFIL
          </button>
        </div>
