...
export default function Cadastro() {
  ...
  return (
    <div className="min-h-screen bg-orange-50 px-4 py-6 sm:px-10 max-w-4xl mx-auto">
      <main>
        <h1 className="text-3xl font-serif font-bold text-orange-800 mb-6 text-center">
          Cadastre-se na GooGroups!
        </h1>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mt-4">
            <div>
              <label htmlFor="pais" className="block font-semibold text-orange-700 mb-1">
                País
              </label>
              <input
                id="pais"
            ...
            <div>
              <label htmlFor="estado" className="block font-semibold text-orange-700 mb-1">
                Estado
              </label>
              <input
                id="estado"
            ...
            <div>
              <label htmlFor="cidade" className="block font-semibold text-orange-700 mb-1">
                Cidade
              </label>
              <input
                id="cidade"
            ...
            <div>
              <label htmlFor="bairro" className="block font-semibold text-orange-700 mb-1">
                Bairro (Opcional)
              </label>
              <input
                id="bairro"
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            <div>
              <label htmlFor="nome" className="block font-semibold text-orange-700 mb-1">
                Nome completo
              </label>
              <input
                id="nome"
            ...
            <div>
              <label
                ...
                className="block font-semibold text-orange-700 mb-1"
              >
            ...
            {/* Nome público */}
            <div>
              <label htmlFor="nomePublico" className="block font-semibold text-orange-700 mb-1">
            ...
            {/* Usuário */}
            <div>
              <label htmlFor="usuario" className="block font-semibold text-orange-700 mb-1">
                Usuário
              </label>
              <input
                id="usuario"
            ...
            {/* E-mail */}
            <div>
              <label htmlFor="email" className="block font-semibold text-orange-700 mb-1">
                E-mail
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="contato" className="block font-semibold text-orange-700 mb-1">
            ...
            {/* Privacidade (radio) */}
            <fieldset>
              <legend className="font-semibold text-orange-700 mb-1">Privacidade do perfil</legend>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Campo Senha */}
            <div>
              <label htmlFor="senha" className="block font-semibold text-orange-700 mb-1">
                Senha
              </label>
              <input
                id="senha"
            ...
            {/* Campo Repita Senha */}
            <div>
              <label htmlFor="repetirSenha" className="block font-semibold text-orange-700 mb-1">
                Repita a Senha
              </label>
              <input
                id="repetirSenha"
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <label htmlFor="souFuncionario" className="font-semibold text-orange-700">
                Sou funcionário
              </label>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <label htmlFor="souEstudante" className="font-semibold text-orange-700">
                Sou estudante
              </label>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <label htmlFor="condEspecial" className="font-semibold text-orange-700">
                Condição especial?
              </label>
            </div>
            ...
            <div>
              <label htmlFor="escolaridade" className="block font-semibold text-orange-700 mb-1">
              ...
              <div>
                <label htmlFor="genero" className="block font-semibold text-orange-700 mb-1">
                  Gênero
                </label>
                <select
                  id="genero"
              ...
              {/* Raça (select) */}
              <div>
                <label htmlFor="raca" className="block font-semibold text-orange-700 mb-1">
                  Raça
                </label>
                <select
                  id="raca"
              ...
              {/* Povos tradicionais */}
              <div>
                <label htmlFor="povosTradicionais" className="block font-semibold text-orange-700 mb-1">
                  Povos tradicionais
                </label>
                <input
              ...
              <div>
                <label htmlFor="bioma" className="block font-semibold text-orange-700 mb-1">
              ...
              <div>
                <label htmlFor="divisaoGeo" className="block font-semibold text-orange-700 mb-1">
              ...
              {/* Apresentação (bio) */}
              <div>
                <label htmlFor="apresentacao" className="block font-semibold text-orange-700 mb-1">
                  Apresentação (Bio)
                </label>
                <textarea
                  id="apresentacao"
            ...
            {/* Foto de perfil */}
            <div>
              <label htmlFor="fotoPerfil" className="block font-semibold text-orange-700 mb-1">
                Foto de perfil
              </label>
              <input
                id="fotoPerfil"
              ...
              {fotoPerfilPreview && (
                <img
                  ...
                  className="mt-2 w-32 h-32 object-cover rounded-full border border-orange-300"
                />
              )}
            </div>
            ...
            <div>
              <label className="block font-semibold text-orange-700 mb-2 mt-4">Álbum de fotos</label>
            ...
            {/* Temas de interesse */}
            <div>
              <label htmlFor="temasInteresse" className="block font-semibold text-orange-700 mb-1 mt-4">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <label htmlFor="receberInformacoes" className="font-semibold text-orange-700">
            ...
            <fieldset className="mt-4">
              <legend className="font-semibold text-orange-700 mb-2">Contatos</legend>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="contatoWhatsapp" className="block font-semibold text-orange-700 mb-1">
                ...
                <div>
                  <label htmlFor="contatoSite" className="block font-semibold text-orange-700 mb-1">
                    Site
                  </label>
                  <input
                    id="contatoSite"
                ...
                <div>
                  <label htmlFor="contatoFacebook" className="block font-semibold text-orange-700 mb-1">
                    Facebook
                  </label>
                  <input
                    id="contatoFacebook"
                ...
                <div>
                  <label htmlFor="contatoInstagram" className="block font-semibold text-orange-700 mb-1">
                    Instagram
                  </label>
                  <input
                    id="contatoInstagram"
                ...
                <div>
                  <label htmlFor="contatoYoutube" className="block font-semibold text-orange-700 mb-1">
                    Youtube
                  </label>
                  <input
                    id="contatoYoutube"
                ...
                <div>
                  <label htmlFor="contatoLinktree" className="block font-semibold text-orange-700 mb-1">
                    Linktree
                  </label>
                  <input
                    id="contatoLinktree"
