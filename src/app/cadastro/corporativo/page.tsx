...
const visibilityOptions: OptionDef[] = [
  { value: '1', label: 'Qualquer Usuário do GooGroups' },
  { value: '2', label: 'Somente os meus AMIGOS do GooGroups' },
...
const fields: FieldDef[] = [
  ...
  { name: 'usuarioGG', label: 'Usuário GooGroups', prefix: '@', required: true },
  ...
  { 
    ...
    fields: [
      ...
      { name: 'loginGG', label: 'Login GooGroups', prefix: '@', required: true },
      { name: 'email', label: 'Email', type: 'email', required: true },
