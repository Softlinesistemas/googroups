// app/cadastro/cnpj-autonomo/page.tsx
'use client'
...
const fields: FieldDef[] = [
  ...
  // Outros
  { name: 'outrasAtividades', label: 'Outras atividades da instituição' },
...
export default function Page() {
  const info = cadastroInfo.autonomo
  
  return (
    <>
      <InfoModal title={info.title} content={info.content} />
      <CadastroTipoForm tipo="CNPJ Autônomo ou Beneficiário" fields={fields} />
      </>
  )
}
