...
export default function FeedPage() {
  ...
  return (
    <div className="bg-orange-100 p-4 rounded shadow max-w-md mx-auto">
      <div className='pb-2'>
        <MainBanner />
      </div>
      <ProducerCard 
...
<div className="flex gap-2 my-4 items-center justify-center">
  ...
  <BotaoAlerta />
      ...
      <h2 className="bg-orange-800 text-white rounded py-1 px-3 mt-4 text-center text-sm">FEED</h2>
