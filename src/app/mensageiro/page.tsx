  ...
  return (
    <div className="bg-white p-4 md:p-6 rounded-lg shadow-md max-w-4xl mx-auto">
      ...
      <div className="flex items-center mb-6">
       <FaSearch className="left-3 top-1/2 transform -translate-y-1/2 text-orange-600" />
      ...
      <div className="mb-6">
        ...
        <div className="space-y-3">
          <select className="w-full p-2 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-orange-500">
