        ...
        >
          ...
          <div className="space-y-6 text-gray-600">
            <p className="text-lg leading-relaxed">
              O GooGroups nasceu da necessidade de modernizar e digitalizar o agronegócio brasileiro. 
        ...
        >
          <div className="card p-8 bg-gradient-to-r from-green-600 to-green-700 text-white">
            ...
            <p className="text-xl mb-6 opacity-90">
              Junte-se a milhares de produtores e empresas que já confiam no GooGroups
            </p>
            <motion.button
