...
export default function FAQPage() {
  ...
  const faqData = {
    geral: [
      {
        question: "O que é o GooGroups?",
        answer:
          "O GooGroups é uma plataforma digital que conecta produtores rurais, fornecedores e consumidores, facilitando a comercialização de produtos agrícolas e promovendo o desenvolvimento sustentável do agronegócio brasileiro.",
      },
      {
      ...
      {
        question: "Em quais regiões o GooGroups atua?",
        answer:
          "Atualmente, o GooGroups atua em todo o território brasileiro, com foco especial nas principais regiões produtoras do país. Estamos constantemente expandindo nossa cobertura.",
      },
    ],
    conta: [
      {
    ...
    suporte: [
      {
        ...
        answer:
          "Você pode entrar em contato através do chat da plataforma, email (suporte@GooGroups.com.br) ou telefone (11) 9999-9999. Nosso horário de atendimento é de segunda a sexta, das 8h às 18h.",
      },
      {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Encontre respostas para as dúvidas mais comuns sobre o GooGroups
          </p>
        </motion.div>
