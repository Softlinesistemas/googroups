...
export const CadastroForm = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#e7c465] overflow-hidden">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2 pt-2">
            ...
            <label className="flex items-center gap-2 text-sm">
              ...
              />
              Qualquer usuário do{" "}
              <span className="text-green-500 font-semibold">GooGroups</span>
            </label>
            <label className="flex items-center gap-2 text-sm">
          ...
          <div className="space-y-2 px-5">
            ...
            <Label className="border p-3 mb-1 text-sm text-black flex items-center gap-2 bg-green-300 rounded-md shadow-md">
              ...
              <a>
                ...
                GooGroups e desejo me cadastrar gratuitamente.
              </a>
            </Label>
          </div>
