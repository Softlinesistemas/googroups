...
export const AuthScreen = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col">
      ...
      <div className="flex-1 bg-orange-100 w-full flex items-start justify-center px-4 sm:px-6 md:px-10 shadow-md relative shadow-black">
        <div className="relative z-10 w-full max-w-3xl bg-white rounded-3xl shadow-2xl shadow-orange-300 p-6 sm:p-8 -mt-16">

          {/* Tabs */}
          <div className="flex bg-gray-100 rounded-full p-1 mb-6">
            <button
              onClick={() => setActiveTab('login')}
              className={`flex-1 text-sm font-semibold py-2 rounded-full ${activeTab === 'login' ? 'bg-orange-700 text-white' : 'text-gray-700'}`}
            >Acessar</button>
            <button
              onClick={() => setActiveTab('cadastro')}
              className={`flex-1 text-sm font-semibold py-2 rounded-full ${activeTab === 'cadastro' ? 'bg-orange-700 text-white' : 'text-gray-700'}`}
            >Criar conta</button>
          </div>
          ...
          {activeTab === 'login' && (
            <div className="space-y-3 gap-2">
              ...
              <button className="w-full bg-orange-700 text-white py-2 rounded-full font-semibold hover:bg-orange-800 transition">
                Acessar
              </button>
            </div>
          )}
          ...
          {activeTab === 'cadastro' && (
            ...
            >
              ...
              {/* Nome público */}
              <Label>O seu nome público no GooGroups*</Label>
              ...
              <div className="flex items-center justify-between">
                ...
                <p className="text-xs text-orange-700">Sua idade ficará sempre oculta.</p>
              </div>
              ...
              <div className="space-y-3 mt-4">
                ...
                {contatosApoio.map((contato, index) => {
                  ...
                  return (
                    <div key={index} className="bg-gray-100 rounded-lg p-3 space-y-3">
                      <div className="flex justify-between items-center bg-orange-100 p-2 rounded-full">
                        ...
                        <div className="flex gap-3 pr-2">
                          ...
                          {/* Ações padrão */}
                          <button type="button" onClick={handleEditar} className="text-orange-700 hover:text-orange-900">
                            <FiEdit2 size={16} />
                          </button>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-center gap-3 pt-2">
                            ...
                            <button
                              ...
                              className="flex items-center gap-1 bg-orange-600 hover:bg-orange-700 text-white text-sm px-4 py-1.5 rounded-md shadow h-12"
                            >
                              ✅ Salvar
                            </button>
                          </div>
                ...
                {contatosApoio.length < 3 && (
                  <button
                    ...
                    className="flex items-center gap-2 text-orange-700 mt-2 text-sm"
                  >
              ...
              <div className="space-y-1">
                <label className="flex items-center gap-2 text-sm">
                  ...
                  Qualquer usuário do <span className="text-orange-500 font-semibold">GooGroups</span>
                </label>
                <label className="flex items-center gap-2 text-sm">
                  <input type="checkbox" {...register('Privacidade')} value="AMIGOS" />
                  Somente meus amigos do <span className="text-orange-500 font-semibold">GooGroups</span>
                </label>
                <label className="flex items-center gap-2 text-sm">
              ...
              <div className="space-y-2 px-5">
                ...
                <label className="flex items-center gap-2 text-sm">
                  <input type="checkbox" {...register('Privacidade')} value="true" /><a>
                    Eu li e concordo com a Política de Privacidade do aplicativo GooGroups e
              ...
              <div className="pt-4 pb-24">
                <button type="submit" className="w-full bg-orange-700 text-white py-2 rounded-full font-semibold hover:bg-orange-800 transition">
                  Criar conta
                </button>
              </div>
            </form>
